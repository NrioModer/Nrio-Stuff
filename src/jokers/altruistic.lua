local j = {
  loc_txt = {
    name = "Altruistic Clown",                                   
        text = {
		"Played cards with non-{C:diamonds}Diamonds{} suit",
                "gives {C:mult}+#1#{} Mult when scored,",
		"while a {C:diamonds}Diamonds{} cards destroys joker", 
        },
  },
...
if JokerDisplay then
    JokerDisplay.Definitions["j_ns_altruistic"] = {
    	text = {
            { text = "+" },
