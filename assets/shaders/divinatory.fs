...
extern MY_HIGHP_OR_MEDIUMP vec2 divinatory;
...
vec3 round_to_palette(vec3 color) {
    const vec3[17] palette = vec3[17](
        ...
        vec3(0.3922, 0.4216, 0.3725),   
        vec3(0.4745, 0.4549, 0.3412),   
        vec3(0.5608, 0.4882, 0.3098),   
        vec3(0.6471, 0.5216, 0.2784), 
        vec3(0.6980, 0.5725, 0.3216),  
        vec3(0.7529, 0.6196, 0.3627),  
        vec3(0.8039, 0.6686, 0.4039), 
        vec3(0.8549, 0.7176, 0.4471),   
        vec3(0.8941, 0.7647, 0.5137),  
        vec3(0.9255, 0.8078, 0.5765), 
        vec3(0.9608, 0.8549, 0.6431),   
        vec3(1.0000, 0.8980, 0.7059),  
        vec3(1.0000, 0.9255, 0.7804), 
        vec3(1.0000, 0.9490, 0.8529),   
        vec3(1.0000, 0.9765, 0.9265),  
...
vec4 effect(vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords) {
    ...
    if(divinatory.g != 0.0) hsl.z = 1.0 - hsl.z;
    if(divinatory.g != 0.0) hsl.z = 1.0 - hsl.z;
